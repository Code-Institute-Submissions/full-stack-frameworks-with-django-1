...
urlpatterns = [
    ...
    path('<tag>s/submitted/', views.get_user_tickets_view,
         name='get-user-tickets'),
    path('<tag>s/saved/', views.get_user_saved_tickets_view,
         name='get-user-saved-tickets'),
    path('bugs/priority/<priority>/', views.get_bugs_priority_view,
         name='get-bugs-priority'),
    ...
    path('<int:ticket_pk>/new-comment/', views.add_new_comment_view,
         name='add-new-comment'),
    path('<int:ticket_pk>/<int:comment_pk>/edit-comment/',
         views.edit_comment_view, name='edit-comment'),
    path('<int:ticket_pk>/<int:comment_pk>/delete-comment/',
    ...
    path('<int:pk>/saved/delete/', views.user_delete_saved_ticket_view,
         name='delete-saved-ticket'),
