...
urlpatterns = [
    ...
    path('user-profile/change-email/', views.change_email_view, name='user-change-email'),
    path('user-profile/change-password/', views.change_password_view, name='user-change-password'),
    # django.contrib.auth
